...
yum erase dhcp openldap-servers openldap-clients bind vsftpd dovecot samba squid net-snmp telnet-server telnet rsh-server rsh ypbind ypserv tftp tftp-server talk talk-server xinetd -y
